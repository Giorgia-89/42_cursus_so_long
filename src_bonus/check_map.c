...
/*   Updated: 2023/11/02 14:46:22 by gd-innoc         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int ft_check_contents(t_data *data)
{
	...
	while (x < data->width / IMG_SIZE - 1)
	{
		...
		{
			if (data->map.map[y][x] != '1' && data->map.map[y][x] != '0' && data->map.map[y][x] != 'P' && data->map.map[y][x] != 'E' && data->map.map[y][x] != 'C')
			{
